# 01_MasterControl — Module README

Purpose
: This README provides the purpose, scope, ownership, and change history for **01_MasterControl** within ENERQIS. It is part of the governed baseline and must be kept accurate and complete.
